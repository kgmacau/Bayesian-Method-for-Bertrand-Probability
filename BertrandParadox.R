...
random_radius<- function(simulation){
  ...
  for (i in 1:simulation){
      ...
      else if (x1/y1>0) y3=(x3+abs(x2))*abs(y1/x1)-abs(y2)
...
random_radius(  simulation=1000000)
...
Bayesian_berparadox<-function(simulation, p1, p2, p3){

    r=1; n=0; n1=0; n2=0; n3=0; m=0; m1=0; m2=0; m3=0;
    method <- c(1, 2, 3) ## 1 random_endpoint, 2 random_radius, 3 rando_midpoint
    simu <- sample(method, size=simulation, replace=TRUE, prob=c(p1, p2, p3))
...
Bayesian_berparadox(simulation=100000, p1=1/3, p2=1/3, p3=1/3);
Bayesian_berparadox(simulation=100000, p1=1/2, p2=1/2, p3=0);
Bayesian_berparadox(simulation=100000, p1=1/4, p2=1/4, p3=1/2);
